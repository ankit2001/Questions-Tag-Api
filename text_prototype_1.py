...
if IN_COLAB:
    ! git clone https://github.com/ankit2001/Questions-Tag-Api.git
...
train = read_data('Questions-Tag-Api/data/train.tsv')
validation = read_data('Questions-Tag-Api/data/validation.tsv')
test = pd.read_csv('Questions-Tag-Api/data/test.tsv', sep='\t')
train.head()
...
prepared_questions = []
for line in open('Questions-Tag-Api/data/text_prepare_tests.tsv', encoding='utf-8'):
